...
# Full Grammar Parse Tree — Stage 106
...
└─► parse_external_declaration
    ...
    │      Collects optional const/volatile/restrict qualifiers + optional storage
...
parse_declaration_specifiers               (file-scope)
   Collects optional const/volatile/restrict + one storage class + one type specifier, any order.
   storage class: "extern" | "static" | "typedef"
   type qualifier: "const" | "volatile" | "restrict"
...
- **Self-hosting (stages 92–106):** the compiler compiles itself. C0
  ...
  stages each re-verified self-hosting. Stages 96, 97, 98, 99, 100, 101, 102,
  103, 104, 105, and 106 all passed self-hosting with no new issues. See

# Full Grammar Parse Tree — Stage 103
...
(gcc-built) compiles itself to C1, and C1 compiles itself to C2, with all 1569
...
- **Block-scope `static` (stage 71; extended stages 101–103):** `parse_statement`
...
- **Self-hosting (stages 92–103):** the compiler compiles itself. C0
  (gcc-built) produces C1, and C1 produces C2; all three pass the full
  1569-test suite, confirming bootstrap stability. The original bootstrap
  ...
  stages each re-verified self-hosting. Stages 96, 97, 98, 100, 101, 102, and 103
  all passed self-hosting with no new issues. See `docs/self-compilation-report.md`.

...
# Full Grammar Parse Tree — Stage 95-12
...
`MAX_SWITCH_LABELS` cap). None of this changes which programs
...
- **Self-hosting (stages 92–95-12):** the compiler compiles itself. C0
  (gcc-built) produces C1, and C1 produces C2; all three pass the full
  1481-test suite, confirming bootstrap stability. The original bootstrap

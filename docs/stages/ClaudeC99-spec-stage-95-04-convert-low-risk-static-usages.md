# ClaudeC99 stage 95-04 convert low risk static usages

## Tasks
  - Using the fix-cpacity-inventory.md report as a guide convert the low-risk static usages
...
## Out of Scope
  - medium and high risk items (these will be done in follow on stages)

...
Through stage 60-01 (static predefined target macros):
...
`Aggregate: P passed, F failed, T total` line. As of stage 60-01 all tests pass (644 valid, 202 invalid, 53 integration, 39 print-AST, 99 print-tokens, 21 print-asm; 1058 total).

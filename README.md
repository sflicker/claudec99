...
`Aggregate: P passed, F failed, T total` line. As of stage 56-04 all
tests pass (625 valid, 195 invalid, 31 integration, 39 print-AST,
99 print-tokens, 21 print-asm; 1010 total).

...
Through stage 60-02 (runtime context predefined macros):
...
`Aggregate: P passed, F failed, T total` line. As of stage 60-02 all tests pass (647 valid, 202 invalid, 53 integration, 39 print-AST, 99 print-tokens, 21 print-asm; 1061 total).

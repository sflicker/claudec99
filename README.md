...
`Aggregate: P passed, F failed, T total` line. As of stage 63 all tests pass (668 valid, 207 invalid, 53 integration, 39 print-AST, 99 print-tokens, 21 print-asm; 1087 total).

...
Through stage 61 (signed type and U suffix support):
...
`Aggregate: P passed, F failed, T total` line. As of stage 61 all tests pass (657 valid, 205 invalid, 53 integration, 39 print-AST, 99 print-tokens, 21 print-asm; 1074 total).

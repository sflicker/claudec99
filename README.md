...
Through stage 21-01 (function declarator refactor):
...
`Aggregate: P passed, F failed, T total` line. As of stage 21-01 all
tests pass (393 valid, 107 invalid, 24 print-AST, 88 print-tokens,
19 print-asm).

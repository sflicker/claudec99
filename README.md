...
Through stage 57-04 (variadic macros):
...
`Aggregate: P passed, F failed, T total` line. As of stage 57-04 all
tests pass (638 valid, 202 invalid, 31 integration, 39 print-AST,
99 print-tokens, 21 print-asm; 1030 total).

...
Through stage 55-09 (bitwise and shift operators in #if/#elif):
...
`Aggregate: P passed, F failed, T total` line. As of stage 55-09 all
tests pass (624 valid, 194 invalid, 27 integration, 39 print-AST,
99 print-tokens, 21 print-asm; 1004 total).

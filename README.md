...
`Aggregate: P passed, F failed, T total` line. As of stage 62 all tests pass (660 valid, 205 invalid, 53 integration, 39 print-AST, 99 print-tokens, 21 print-asm; 1077 total).

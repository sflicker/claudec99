...
`Aggregate: P passed, F failed, T total` line. As of stage 57-01 all
tests pass (633 valid, 199 invalid, 31 integration, 39 print-AST,
99 print-tokens, 21 print-asm; 1022 total).

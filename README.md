...
```
ccompiler [--print-ast | --print-tokens] [-DNAME[=VAL]] <source.c>
```
...
`Aggregate: P passed, F failed, T total` line. As of stage 56-02 all
tests pass (625 valid, 195 invalid, 29 integration, 39 print-AST,
99 print-tokens, 21 print-asm; 1008 total).

# ClaudeC99 Project Status — Through Stage 95-11

_As of 2026-06-08 (commit `be5cbca`)_
...
cycle. Stages 95-02 through 95-11 are an internal **dynamic-storage refactor**:
...
lexer-owned string pool. No language features changed in this range.

**Stages completed: 201** (stage-01 through stage-95-11, including substages).
...
| Total LOC (src + include)     | 13,715         |
| Unit-test assertions          | 165            |
| Valid runtime tests           | 831            |
...
All 1,479 tests pass with no regressions — under the gcc-built compiler and
...
## Stage-by-Stage Timeline (76–95-11)
...
| **95-11**  | **codegen.h name/label fields → `const char *` (current)**    |

## Recently Shipped (Stages 94–95-11)
...
in `docs/other/stage-95-11-parse-tree.md`, and the feature checklist in

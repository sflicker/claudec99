# ClaudeC99 Project Status — Through Stage 117

_As of 2026-06-14 (commit `8dfd45c`)_
...
**Stages completed: 238** (stage-01 through stage-117, including substages).
...
| Total LOC (src + include)     | 16,634         |
| Valid runtime tests           | 1,181          |
...
All 1,863 tests pass with no regressions — under the gcc-built compiler (C0)
...
### Floating-point types and calling convention (stages 109–117)
...
## Stage-by-Stage Timeline (76–117)
...
| **117**    | **FP struct member rvalue reads (dot, arrow, subscript-then-dot) (current)**|

## Recently Shipped (Stages 114–117)
...
in `docs/other/stage-117-parse-tree.md`, and the feature checklist in

# ClaudeC99 Project Status — Through Stage 107

_As of 2026-06-13 (commit 1ea38bc)_
...
**Stages completed: 214** (stage-01 through stage-107, including substages).
...
| Total LOC (src + include)     | 15,320         |
| Valid runtime tests           | 930            |
...
All 1,615 tests pass with no regressions — under the gcc-built compiler and
...
## Stage-by-Stage Timeline (76–107)
...
| **107**    | **`inline` keyword, `<assert.h>` stub, `va_copy` codegen (current)**         |

## Recently Shipped (Stages 105–107)
...
in `docs/other/stage-107-parse-tree.md`, and the feature checklist in
